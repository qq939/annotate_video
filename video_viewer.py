...
class VideoViewer(QMainWindow):
    ...
    def init_ui(self):
        ...
        if self.control_panel:
            if hasattr(self.control_panel, 'handle_viewer_click'):
                self.video_clicked.connect(self.control_panel.handle_viewer_click)
            elif hasattr(self.control_panel, 'handle_click'):
                self.video_clicked.connect(self.control_panel.handle_click)
