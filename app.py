...
class AnnotationDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        instr_label.setStyleSheet("color: #ccc; font-size: 24px;")
...
class AngleAdjustDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.info_label.setStyleSheet("color: #ccc; font-size: 28px; font-weight: bold;")
        header_layout.addWidget(self.info_label)

        self.angle_label = QLabel("角度: 0")
        self.angle_label.setStyleSheet("color: #ff0; font-size: 28px;")
...
class UnifiedPanel(QMainWindow):
    ...
    def create_annotate_section(self):
        ...
        self.start_time_input.setFixedHeight(44)
        ...
        self.max_frames_input.setFixedHeight(44)
        ...
        self.skip_frames_input.setFixedHeight(44)
        ...
        self.resize_ratio_input.setFixedHeight(44)
        ...
        self.merge_iou_input.setFixedHeight(44)
        ...
        self.iou_input.setFixedHeight(44)
        ...
        self.items_input.setFixedHeight(44)
        ...
        self.annotate_btn.setFixedHeight(56)
    ...
    def create_viewer_section(self):
        ...
        self.path_input.setFixedHeight(44)
        ...
        self.backward_fast_btn.setFixedHeight(48)
        ...
        self.backward_btn.setFixedHeight(48)
        ...
        self.forward_fast_btn.setFixedHeight(48)
        ...
        self.backward_cb.setFixedHeight(48)
        self.backward_cb.setChecked(True)
        self.backward_cb.setStyleSheet("QCheckBox { font-size: 22px; }")
        frame_play_layout.addWidget(self.backward_cb)

        self.prompt_btn = QPushButton("提示帧")
        self.prompt_btn.setFixedHeight(48)
        self.prompt_btn.setStyleSheet("QPushButton { background-color: #FFA500; color: white; border: none; border-radius: 3px; font-size: 22px; } QPushButton:hover { background-color: #FF8C00; }")
        ...
        self.frame_label.setFixedHeight(48)
        self.frame_label.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        self.frame_label.setStyleSheet("QLabel { background-color: #333; color: #fff; border-radius: 3px; font-weight: bold; font-size: 28px; padding: 0 8px; }")
        frame_play_layout.addWidget(self.frame_label)

        self.undo_prompt_btn = QPushButton("回退")
        self.undo_prompt_btn.setFixedHeight(48)
        self.undo_prompt_btn.setStyleSheet("QPushButton { background-color: #CC0000; color: white; border: none; border-radius: 3px; font-size: 22px; } QPushButton:hover { background-color: #990000; }")
        ...
        self.forward_cb.setFixedHeight(48)
        self.forward_cb.setChecked(True)
        self.forward_cb.setStyleSheet("QCheckBox { font-size: 22px; }")
        ...
        self.delete_trace_input.setFixedHeight(48)
        ...
        btn_style = "QPushButton { background-color: #6c757d; color: white; border: none; border-radius: 3px; font-size: 22px; } QPushButton:hover { background-color: #5a6268; }"
        btn_blue = "QPushButton { background-color: #007bff; color: white; border: none; border-radius: 3px; font-size: 22px; } QPushButton:hover { background-color: #0069d9; }"
        btn_red = "QPushButton { background-color: #dc3545; color: white; border: none; border-radius: 3px; font-size: 22px; } QPushButton:hover { background-color: #c82333; }"
        ...
        self.trace_id_input.setFixedHeight(56)
    ...
    def create_save_section(self):
        ...
        self.save_input_dir.setFixedHeight(44)
        ...
        self.save_output_name.setFixedHeight(44)
        ...
        self.labelme_title.setFixedHeight(44)
        ...
        self.labelme_digit.setFixedHeight(44)
        ...
        self.render_segment_check.setStyleSheet("QCheckBox { font-size: 22px; }")
        ...
        self.trail_duration.setFixedHeight(44)
        ...
        self.overlap_iou_input.setFixedHeight(44)
